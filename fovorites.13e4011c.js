async function e(e){try{let t=await fetch(e);return await t.json()}catch(e){console.log("err",e)}}const t=document.querySelector(".exercises__list"),s=document.querySelector(".exercises-cards__pagination");function a(){let a=null,i=s=>{e(s).then(e=>{t.innerHTML="",e.results.forEach(e=>{t.insertAdjacentHTML("afterbegin",function({name:e,filter:t}){return`<li class="exercises__item">
    ...
    <div class="body-parts-about-box">
      ...
      <p class="body-parts-about__title">
        ...
        <img class="favorites-info-img" src="./images/favorites/dumbbell.png" alt="dumbbell">
        <p class="favorites-info-text">It appears that you haven't added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future\u{1F60A}</p>
    </div>`;const u=document.querySelector("body");async function g(e){let t=!1,s=e.currentTarget.dataset.id,a=await d(s);function i(e){let t=document.querySelector(".favorite-wrap");e?(t.innerHTML=`<button type="button" class="modal-remove-favorite-btn modal-btn">Remove from 
...
//# sourceMappingURL=fovorites.13e4011c.js.map
