!function(){async function t(t){try{let e=await fetch(t);return await e.json()}catch(t){console.log("err",t)}}let e=document.querySelector(".exercises__list"),s=document.querySelector(".exercises-cards__pagination");function a(){let a=null,i=s=>{t(s).then(t=>{e&&(e.innerHTML="",t.results.forEach(t=>{e.insertAdjacentHTML("afterbegin",function({name:t,filter:e}){return`<li class="exercises__item">
      ...
      <div class="body-parts-about-box">
        ...
        <p class="body-parts-about__title">
          Target: <span class="body-parts-about__span">${o[0].toUpperCase()+o.slice(1)}</span>
            ...
            <img class="favorites-info-img" src="./images/favorites/dumbbell.png" alt="dumbbell">
            <p class="favorites-info-text">It appears that you haven't added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future\u{1F60A}</p>
        </div>`}l();let n=document.querySelector("body");async function d(t){let e=!1,s=t.currentTarget.dataset.id,a=await o(s);function i(t){let e=document.querySelector(".favorite-wrap");t?(e.innerHTML=`<button type="button" class="modal-remove-favorite-btn modal-btn">Remove from 
