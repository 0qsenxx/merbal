async function t(t){try{let e=await fetch(t);return await e.json()}catch(t){console.log("err",t)}}const e=document.querySelector(".exercises__list"),s=document.querySelector(".exercises-cards__pagination");function a(){let a=null,i=s=>{t(s).then(t=>{e.innerHTML="",t.results.forEach(t=>{e.insertAdjacentHTML("afterbegin",function({name:t,filter:e}){return`<li class="exercises__item">
    ...
    <div class="body-parts-about-box">
      ...
      <div class="body-parts-about-box">
        ...
        <img class="favorites-info-img" src="./images/favorites/dumbbell.png" alt="dumbbell">
        <p class="favorites-info-text">It appears that you haven't added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future\u{1F60A}</p>
    </div>`;const g=document.querySelector("body");async function u(t){let e=!1,s=t.currentTarget.dataset.id,a=await d(s);function i(t){let e=document.querySelector(".favorite-wrap");t?(e.innerHTML=`<button type="button" class="modal-remove-favorite-btn modal-btn">Remove from 
...
//# sourceMappingURL=fovorites.fe78c99f.js.map
